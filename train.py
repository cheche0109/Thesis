...
from my_dataset import PDBDataset
...
def main(args):
    ...
    early_stopping = S.EarlyStopping(delta=0.00001)
...
def parse_args():
    ...
    parser.add_argument('--lr', default=0.01, type=float, help='initial learning rate') # adam: 
